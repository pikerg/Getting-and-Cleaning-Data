...
*The above information was copied from the README.txt file included in the data download.*
...
* Using the run_analysis.R script the data set was processed as followes:
	*The following files were read into the Global Environment of RStudio:
		*y_test.txt
		*X_test.txt
  *subject_test.txt
  *y_train.txt
